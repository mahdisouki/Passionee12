const fixtureModel = require("../../models/match/fixtureModels");
const pickteamModel = require("../../models/match/pickteamModels");
...
const userpointsTP = require("../../models/points/userPointsTeamPerso");
...
async function redeemPointsTitulaires(fixture) {
    ...
    for (let y = 0; y < users.length; y++) {
        ...
        ;
        /*  const userpts=await userpointsModel.findOne({ round:round, userId: user.id });
          if(!userpts){
